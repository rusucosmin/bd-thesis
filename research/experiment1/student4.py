...
class Student4(Model):
  def __init__(self, name):
    print("Student4:__init__")
    super().__init__(name)
    ...
    self.W_conv_max_pool_1 = Model.weight_variable([2, 2, 3, 3])
    self.b_conv_max_pool_1 = Model.bias_variable([3])
